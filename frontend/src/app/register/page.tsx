  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden p-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-[max(1rem,env(safe-area-inset-top))]">
      <div
        ...
        style={{
          background:
            "radial-gradient(80rem 36rem at 15% -10%, rgba(34,211,238,0.14), transparent 55%), radial-gradient(70rem 34rem at 95% 0%, rgba(168,85,247,0.12), transparent 58%)",
        }}
      />
      <div className="glass-panel relative w-full max-w-md border border-white/15 bg-slate-950/55 p-6 shadow-[0_30px_80px_rgba(2,6,23,0.65)] sm:p-8 md:p-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm leading-relaxed text-slate-300">
            Crie sua conta para simular cenários e acompanhar o impacto na carteira.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {info ? (
            <p className="rounded-xl border border-emerald-500/30 bg-emerald-950/30 px-3 py-2 text-sm text-emerald-300/90" role="status">
              {info}
            </p>
          ) : null}
